...
% if strcmp(exp,'2019-14')
    ...
    rew_threshold= [ "353 Timeout Day 04"; "354 Timeout Day 02"; "361 Timeout Day 06"; "362 Timeout Day 05"; "363 Timeout Day 04"; "365 Timeout Day 02" ];
...
%     
    ...
    Ext_Day_test = strfind(day_align_filenames,Ext_Day(CaMKIInum));
    
    Ext_Day_day = find(~cellfun(@isempty,Ext_Day_test),1);
    
    Ext_Day_day_all_mice(:,CaMKIInum) = day_align(:,Ext_Day_day );
    
%% For collapsing groups
 %    Cued_day_1
    Cued_day_1_test = strfind(lower(day_align_filenames),lower([num2str(camkii_gcamp(CaMKIInum)) ' Cued Day 01']));
    ...
    %    Cued_day_4
    Cued_day_4_test = strfind(lower(day_align_filenames),lower([num2str(camkii_gcamp(CaMKIInum)) ' Cued Day 04']));
    ...
    TO_day_02_test = strfind(lower(day_align_filenames),lower([num2str(camkii_gcamp(CaMKIInum)) ' Timeout Day 02']));
    
    TO_day_02_day = find(~cellfun(@isempty,TO_day_02_test),1);
    
    TO_day_02_day_all_mice(:,CaMKIInum) = day_align(:,TO_day_02_day);
...
yline(4.5 - 0.5 , 'w', 'LineWidth', 1.75);
