...
%4/29/20 - modified for ACh3.0 mice, removed some days in the collapsed
...
rew_threshold = ["124 Timeout Day 09"; "129 Timeout Day 03"; "176 Timeout Day 10"; "850 Timeout Day 06"; "1012 Timeout Day 03" ];
Ext_Day =["124 ZExtinction Day 01"; "129 ZExtinction Day 03"; "176 ZExtinction Day 01"; "850 ZExtinction Day 01"; "1012 ZExtinction Day 03"];
...
for num = nummer
    ...
    Ext_Day_test = strfind(day_align_filenames,Ext_Day(gachnum));
    ...
    %    Cued_day_1
    Cued_day_1_test = strfind(lower(day_align_filenames),lower([num2str(gach(gachnum)) ' Cued Day 01']));
    ...
    %    Cued_day_5
    Cued_day_4_test = strfind(lower(day_align_filenames),lower([num2str(gach(gachnum)) ' Cued Day 04']));
    
    Cued_day_4_day = find(~cellfun(@isempty,Cued_day_4_test),1);
    
    Cued_day_4_all_mice(:,gachnum) = day_align(:,Cued_day_4_day);
    
    %TO_day_02
    
    TO_day_02_test = strfind(lower(day_align_filenames),lower([num2str(gach(gachnum)) ' Timeout Day 02']));
    
    TO_day_02_day = find(~cellfun(@isempty,TO_day_02_test),1);
    
    TO_day_02_day_all_mice(:,gachnum) = day_align(:,TO_day_02_day);
