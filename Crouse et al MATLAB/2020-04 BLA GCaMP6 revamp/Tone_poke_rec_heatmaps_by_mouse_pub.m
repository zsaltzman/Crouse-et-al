%% tone_to_poke_heatmaps_by_mouse_plots
...
rew_threshold = [ "353 Timeout Day 04" "361 Timeout Day 06" "362 Timeout Day 05" "363 Timeout Day 04"];
Ext_Day = ["353 ZExtinction Day 01" "361 ZExtinction Day 01" "362 ZExtinction Day 01" "363 ZExtinction Day 01"];
...
for num = nummer
    ...
    rew_thresh_test = strfind(day_align_filenames,rew_threshold(gcampnum));
    ...
    Ext_Day_test = strfind(day_align_filenames,Ext_Day(gcampnum));
    ...
    %    Cued_day_1
    Cued_day_1_test = strfind(lower(day_align_filenames),lower([num2str(gcamp6(gcampnum)) ' Cued Day 01']));
    ...
    %    Cued_day_5
    Cued_day_4_test = strfind(lower(day_align_filenames),lower([num2str(gcamp6(gcampnum)) ' Cued Day 04']));
    ...
    TO_day_02_test = strfind(lower(day_align_filenames),lower([num2str(gcamp6(gcampnum)) ' Timeout Day 02']));
