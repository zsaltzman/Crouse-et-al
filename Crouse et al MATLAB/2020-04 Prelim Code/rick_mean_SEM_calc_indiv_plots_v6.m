...
% if strcmp(exp,'2020-04')
    ...
    folder = 'C:\Users\User\Google Drive\2020-04 FP\Doric\MATLAB' ;
    outputfolder = 'C:\Users\User\Google Drive\2020-04 FP\Doric\MATLAB\Individual Day Graphs';
...
%save here, edit what you save up top to prevent scrolling a ton, rcamp
save([outputfolder '\MATLAB vars\' save_name '.mat'], 'graphmean', 'graphsem', 'datanames','r_graphmean', 'r_graphsem', '-v7.3');
